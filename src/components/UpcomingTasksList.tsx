...
const UpcomingTasksList: React.FC<UpcomingTasksListProps> = ({ tasks, onTaskClick, onToggleComplete }) => {
  return (
    <div style={{ backgroundColor: 'white', padding: '20px', borderRadius: '8px', boxShadow: '0 2px 5px rgba(0,0,0,0.1)' }}>
      <h3 style={{ marginTop: 0, color: '#ffc107' }}>Upcoming Tasks (Next 7 Days)</h3>
      {tasks.length === 0 ? (
